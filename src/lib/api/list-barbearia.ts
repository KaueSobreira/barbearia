...
export const barbeariaService = {
  async getAllBarbearias() {
    try {
      // console.log(
      //   "Tentando buscar barbearias do endpoint:",
      //   `${api.defaults.baseURL}/barbearia/fetch-barber-shops`,
      // ); // Log mais específico
      ...
      // console.log(
      //   "Barbearias extraídas para processamento:",
      //   barbearias.length,
      //   "itens.",
      // );
      ...
      console.error(
        "Erro ao chamar a API de barbearias em list-barbearia.ts:",
        error,
      );
      throw error;
    }
